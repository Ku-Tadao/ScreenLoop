    ...
    internal static class SettingsService
    {
        ...
        public static bool LoadSettings()
        {
            try
            {
                ...
                Settings.Instance.RecordingMode = RecordingMode.Buffer;
                Settings.Instance.AudioOutputMode = AudioOutputMode.All;
                Settings.Instance.InputNoiseSuppression = false;
        ...
        private static async Task UpdateSettingsInstance(Settings updatedSettings)
        {
            ...
            updatedSettings.RecordingMode = RecordingMode.Buffer;
            updatedSettings.AudioOutputMode = AudioOutputMode.All;
            updatedSettings.InputNoiseSuppression = false;
            ...
            if (settings.AlwaysRecord != updatedSettings.AlwaysRecord)
            {
                Log.Information($"AlwaysRecord changed from '{settings.AlwaysRecord}' to '{updatedSettings.AlwaysRecord}'");
                settings.AlwaysRecord = updatedSettings.AlwaysRecord;
                hasChanges = true;

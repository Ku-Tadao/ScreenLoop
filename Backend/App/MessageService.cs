            ...
            try
            {
                ...
                if (root.TryGetProperty("Method", out JsonElement methodElement))
                {
                    ...
                    switch (method)
                    {
                        ...
                        case "Login":
                        case "Logout":
                            Log.Information("{Method} ignored because ScreenLoop is local-only.", method);
                            break;
                        case "CancelClip":
                        ...
                        case "UploadContent":
                            ...
                            break;
                        case "CancelUpload":
                            Log.Information("CancelUpload ignored because ScreenLoop is local-only.");
                            break;
                        ...
                        case "OpenLogsLocation":
                            ...
                            string logDir = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "ScreenLoop");
                            ...
                            {
                                Log.Warning("No log files found in the ScreenLoop directory");
                            }
                            break;
                        case "SelectGameExecutable":
                            Log.Information("SelectGameExecutable ignored because game detection has been removed.");
                            break;
                        case "StartRecording":

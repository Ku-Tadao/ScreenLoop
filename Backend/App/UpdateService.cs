...
namespace ScreenLoop.Backend.App
{
    public static class UpdateService
    {
        ...
        public static GithubSource Source = new GithubSource("https://github.com/Ku-Tadao/ScreenLoop", null, false);
        public static GithubSource BetaSource = new GithubSource("https://github.com/Ku-Tadao/ScreenLoop", null, true);
...
#pragma warning restore CS8625
        ...
        public static async Task GetReleaseNotes()
        {
            try
            {
                ...
                httpClient.DefaultRequestHeaders.UserAgent.Add(new ProductInfoHeaderValue("ScreenLoop", currentVersion.ToString()));

                // Fetch releases from GitHub API
                var response = await httpClient.GetAsync($"https://api.github.com/repos/Ku-Tadao/ScreenLoop/releases");

    ...
    public static class FFmpegErrors
    {
        ...
        public static (string Message, bool LikelyBug) Describe(int exitCode)
        {
            return exitCode switch
            {
                ...
                -1 => ("ScreenLoop was not permitted to perform the operation.", false),
                ...
                -12 => ("ScreenLoop ran out of memory while processing the video.", false),
                ...
                -24 => ("Too many files are open. Please restart ScreenLoop and try again.", false),
